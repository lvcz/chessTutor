...
class HighlightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create highlight" do
    assert_difference('Highlight.count') do
      post highlights_url, params: { highlight: { cor: @highlight.cor, peca: @highlight.peca, valor: @highlight.valor } }
    end
  ...
  test "should update highlight" do
    patch highlight_url(@highlight), params: { highlight: { cor: @highlight.cor, peca: @highlight.peca, valor: @highlight.valor } }
