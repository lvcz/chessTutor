...
class MovesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create move" do
    assert_difference('Move.count') do
      post moves_url, params: { move: { aula_id: @move.aula_id, from: @move.from, to: @move.to } }
    end
  ...
  test "should update move" do
    patch move_url(@move), params: { move: { aula_id: @move.aula_id, from: @move.from, to: @move.to } }
