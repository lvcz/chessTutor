...
class AulasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aula" do
    assert_difference('Aula.count') do
      post aulas_url, params: { aula: { conteudo: @aula.conteudo, fen: @aula.fen, moves: @aula.moves, nome: @aula.nome, usuario_id: @aula.usuario_id } }
    end
  ...
  test "should update aula" do
    patch aula_url(@aula), params: { aula: { conteudo: @aula.conteudo, fen: @aula.fen, moves: @aula.moves, nome: @aula.nome, usuario_id: @aula.usuario_id } }
