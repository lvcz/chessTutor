...
class MarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mark" do
    assert_difference('Mark.count') do
      post marks_url, params: { mark: { aula_id: @mark.aula_id, cor: @mark.cor, quadro: @mark.quadro, valor: @mark.valor } }
    end
  ...
  test "should update mark" do
    patch mark_url(@mark), params: { mark: { aula_id: @mark.aula_id, cor: @mark.cor, quadro: @mark.quadro, valor: @mark.valor } }
